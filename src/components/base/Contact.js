...
function Contact() {
    ...
    return (
        <section id="contactSection" className="common-style pt-2">
            <div className="container">
                ...
                <div className="row">
                  <ul className="social-media-contact">
                    <li>
                      <a className="facebook rounded-circle" href="https://www.facebook.com/Slovesindia">
                    ...
                    <li>
                      <a className="instagram rounded-circle" href="https://www.instagram.com/thehappeninghomo/">
                    ...
                    <li>
                      <a className="whatsapp rounded-circle" href="https://web.whatsapp.com/">
                    ...
                    <li>
                      <a className="twitter rounded-circle" href="https://twitter.com/HappeningHomo/">
                    ...
                    <li>
                      <a className="gmail rounded-circle" href="mailto:kushwahasonali7feb@gmail.com">
                    ...
                    <li>
                      <a className="linkedin rounded-circle" href="https://www.linkedin.com/in/thehappeninghomo/">
                    ...
                    <li>
                      <a className="github rounded-circle" href="https://github.com/thehappeninghomo/">
